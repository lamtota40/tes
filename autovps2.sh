...
cd
sudo bash -c "echo 'CUSTOM_BOOTOPTIONS=\"ssh=pas123 vnc=pas123 netscript=https://raw.githubusercontent.com/lamtota40/tes/main/setup-ngrok.sh toram\"' >> /etc/default/grml-rescueboot"
