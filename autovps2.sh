...
cd
sudo bash -c "echo 'CUSTOM_BOOTOPTIONS=\"ssh=pas123 vnc=pas123 dns=8.8.8.8,8.8.4.4 netscript=https://raw.githubusercontent.com/lamtota40/tes/main/setup-ngrok.sh toram startx\"' >> /etc/default/grml-rescueboot"
