...
wget -c --retry-connrefused --tries=10 --waitretry=1 --timeout=5 https://raw.githubusercontent.com/lamtota40/tes/main/ngrok.yml
wget -c --retry-connrefused --tries=10 --waitretry=1 --timeout=5 $DOWNLOAD_URL
unzip $ARCHIVE
chmod +x ngrok
clear
